...
- Cuenta en https://render.com (gratuita).
...
5. Configurar:
   ...
   - **Start Command:** `java -jar target/vetcare-0.0.1-SNAPSHOT.jar`
   - **Instance Type:** Free
...
| Key | Value |
|---|---|
| `DB_URL` | `jdbc:mysql://[host-aiven]:[puerto]/vetcaredb?useSSL=true` |
...
1. https://aiven.io → cuenta gratuita.
